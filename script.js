...
const quizzes = {
  ...
  "quiz2.html": [
    ...
    { question: "Cili është rrethi me sipërfaqe më të madhe?", answers: { a: "R = 4", b: "R = 5", c: "R = 3.5" }, correct: "b" },
    { question: "Sa është π × 10²?", answers: { a: "314.16", b: "100", c: "141.6" }, correct: "a" },
    { question: "Sa është rrënja katrore e (π²)?", answers: { a: "π", b: "3.14", c: "9.86" }, correct: "a" },
    { question: "Nëse një rreth ka perimetër 62.8 cm, sa është diametri i tij (π ≈ 3.14)?", answers: { a: "20 cm", b: "15 cm", c: "25 cm" }, correct: "a" },
    ...
    { question: "Cili është volumi i një sfere me rreze 3 cm? (4/3 × π × r³)", answers: { a: "113.1 cm³", b: "90 cm³", c: "105 cm³" }, correct: "a" }
],
